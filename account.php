                     ...
                     <div class="tablecard-body">
                        <table class="leadsTable" style="width:100%">
                           <thead>
                              <tr>
                                 <th>
                                    <h6><span class="material-symbols-outlined">whatshot</span> Recever Account </h6>
                                 </th>
                                 <th>
                                    <h6><span class="material-symbols-outlined">transition_push</span> Sender Account </h6>
                                 </th>
                                 <th>
                           ...
                           <tbody>
                              <tr>
                                 <td><a href="account-detail.php" class="fs-7 fw-bold text-nowrap">Eassypaysa</a></td>
                                 <td><a href="account-detail.php" class="fs-7 fw-bold text-nowrap">Cash</a></td>
                                 <td class=" mw-25">2 Dec 2023</td>
                                 <td class="text-nowrap">500 PKR</td>
                              </tr>

                              <tr>
                                 <td><a href="account-detail.php" class="fs-7 fw-bold text-nowrap">UBL</a></td>
                                 <td><a href="account-detail.php" class="fs-7 fw-bold text-nowrap">Cash</a></td>
                                 <td class=" mw-25">22 Dec 2023</td>
                                 <td class="text-nowrap">500 PKR</td>
                              </tr>
                           </tbody>
                           <tfoot>
   ...
   <script>
      $(document).ready(function () {
         ...
         function updateSumFooter() {
            var columnIndex = 3; // Replace 0 with the actual index of the 'Amount' column
         ...
         $('input[name="datefilter"]').on('apply.daterangepicker', function (ev, picker) {
            ...
            var filteredData = initialTableData.filter(function (rowData) {
               var rowDate = rowData[2]; // Assuming column 8 (index 7) contains the date
            ...
            if (filteredData.length > 0 && table.rows().any()) {
               ...
               table.column(3).footer().innerHTML = `<h6>0 PKR</h6>`;
            }
         });
