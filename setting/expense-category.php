                                       ...
                                       <div class="channelCard-body">
                                          <form>
                                             <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                   <input type="text" id="expense_category" name="expense_category" placeholder="Enter Expense Category Name">
                                                </div>
                                                <div class="col-md-3">
                                    ...
                                    <div class="customization-table">
                                       <table class="table">
                                          ...
                                          <tbody>
                                             ...
                                             <tr>
                                                <td>Home</td>
                                                <td><a href="#" class="text-primary link-opacity-50-hover">8</a></td>
                                                <td>
                                                   <div class="">
                                                      <button class="btn btn-danger">Delete</button>
                                                      <button class="btn btn-success">Edit</button>
