                                       ...
                                       <div class="channelCard-body">
                                          <form>
                                             ...
                                             <div class="row mb-3">
                                                ...
                                                <div class="col-md-5">
                                                   <input type="text" id="user_name" name="user_name" value="Ali Usman" placeholder="Enter User Name">
                                                </div>
                                             </div>
                                             ...
                                             <div class="row mb-3">
                                                ...
                                                <div class="col-md-5">
                                                   <input type="email" id="user_email" name="user_email" value="a.usman@netdock.com" placeholder="Enter User Email">
                                                </div>
                                             </div>
                                             ...
                                             <div class="row mb-3">
                                                ...
                                                <div class="col-md-5">
                                                   <input type="text" id="user_phone" name="user_phone" value="03415892356" placeholder="Enter Phone Number">
                                                </div>
                                             </div>
                                             ...
                                             <div class="row mb-3">
                                                ...
                                                <div class="col-md-5">
                                                   <input type="text" id="user_whatsapp" name="user_whatsapp" value="03415892356" placeholder="Enter Whatsapp Number">
                                                </div>
                                             </div>
                                             ...
                                             <div class="row mb-3">
                                                ...
                                                <div class="col-md-5">
                                                   <select name="user_role" id="user_role">
                                                      ...
                                                      <option value="2" selected>Bill Collect</option>
                                             ...
                                             <div class="row mb-3">
                                                ...
                                                <div class="col-md-5">
                                                   <input type="text" id="user_address" name="user_address" value="abc, Area Xyz, Karachi" placeholder="Enter Compay Address">
                                                </div>
                                             </div> 
                                             ...
                                             <div class="row mb-3">
                                                ...
                                                <div class="col-md-5">
                                                   <input type="text" id="user_salary" name="user_salary" value="30000" placeholder="Enter User Salary">
                                                </div>
                                             </div> 
                                             ...
                                             <div class="row">
                                                <div class="col-md-7">
                                                   <a href="#" class="btn bg-primary pe-3 ps-2 d-inline-flex align-items-center">
                                                      <span class="material-symbols-outlined me-2">edit_note</span> Edit User
                                                   </a>
                                                </div>
                                             </div> 
                                          </form>
