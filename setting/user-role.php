                                       ...
                                       <div class="channelCard-body">
                                          <form>
                                             <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                   <input type="text" id="user_role" name="user_role" placeholder="Enter User Role Name">
                                                </div>
                                                <div class="col-md-3">
                                                   <button type="submit" class="btn bg-primary pe-3 ps-2 pb-1 pt-1 w-100 h-100 text-center fs-6 text-white d-inline-flex align-items-center justify-content-center">
                                                      <span class="material-symbols-outlined me-2 text-white">add</span> Add Role
                                                   </button>
                                                </div>
                                             </div>
                                          </form>
                                    ...
                                    <div class="customization-table">
                                       <table class="table">
                                          ...
                                          <tbody>
                                             <tr>
                                                <td>Super Admin</td>
                                                <td><a href="#" class="text-primary link-opacity-50-hover">1</a></td>
                                                <td>
                                                   <div class="">
                                             ...
                                             <tr>
                                                <td>Admin</td>
                                                <td><a href="#" class="text-primary link-opacity-50-hover">2</a></td>
                                                <td>
                                                   <div class="">
                                                      <button class="btn btn-danger">Delete</button>
                                                      <button class="btn btn-success">Edit</button>
                                             ...
                                             <tr>
                                                <td>Bill Collect</td>
                                                <td><a href="#" class="text-primary link-opacity-50-hover">6</a></td>
                                                <td>
                                                   <div class="">
                                                      <button class="btn btn-danger">Delete</button>
                                                      <button class="btn btn-success">Edit</button>
